...
static void sensor_timer_handler(struct timer_list *t)
{
    ...
    kill_fasync(&sensor_async,SIGIO,POLLIN);
...
{
    return fasync_helper(fd,file,on,&sensor_async);
}
